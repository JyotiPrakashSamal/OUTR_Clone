        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 text-left">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="bg-white border border-slate-200/85 rounded-3xl p-6 shadow-sm">
              ...
              {errorMsg && (
                <div className="p-3 bg-red-50 text-red-700 border border-red-200 rounded-xl mb-4 text-xs font-semibold flex items-center gap-1.5">
                  <AlertTriangle className="w-4 h-4 shrink-0" /> {errorMsg}
                </div>
              )}
              {successMsg && (
                <div className="p-3 bg-emerald-50 text-emerald-700 border border-emerald-200 rounded-xl mb-4 text-xs font-semibold flex items-center gap-1.5">
